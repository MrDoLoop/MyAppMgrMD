...
public class ViewDragHelper {
     ...
     *
     * @param forParent Parent view to monitor
     * @param sensitivity Multiplier for how sensitive the helper should be about detecting the start of a drag. Larger
     *            values are more sensitive. 1.0f is normal.
     * @param cb Callback to provide information and receive events
     * @return a new ViewDragHelper instance
     */
     ...
     * @param sensitivity value between 0 and 1, the final value for touchSlop = ViewConfiguration.getScaledTouchSlop *
     *            (1 / s);
     */
    ...
    /**
     * Set the max velocity that will be detected as having a magnitude greater than zero in pixels per second. Callback
     * methods accepting a velocity will be clamped appropriately.
     *
     ...
     * {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be
    ...
    /**
     * Set the size of an edge. This is the range in pixels along the edges of this view that will actively detect edge
     * touches or drags if edge tracking is enabled.
     *
     ...
     * {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be
     * asked permission to capture this view.
     *
     ...
     *
     * @param deferCallbacks true if state callbacks should be deferred via posted message. Set this to true if you are
     *            calling this method from {@link android.view.View#computeScroll()} or similar methods invoked as part
     ...
     * </p>
     *
     * @param directions Combination of direction flags, see {@link #DIRECTION_HORIZONTAL}, {@link #DIRECTION_VERTICAL},
     *            {@link #DIRECTION_ALL}
     ...
     *
     * @param edges Edges to check for an initial edge touch. See {@link #EDGE_LEFT}, {@link #EDGE_TOP},
    ...
    private void releaseViewForPointerUp() {
        ...
        final float xvel =
                clampMag(VelocityTrackerCompat.getXVelocity(mVelocityTracker, mActivePointerId), mMinVelocity,
                        mMaxVelocity);
        final float yvel =
                clampMag(VelocityTrackerCompat.getYVelocity(mVelocityTracker, mActivePointerId), mMinVelocity,
                        mMaxVelocity);
     ...
     * determined using {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#getOrderedChildIndex(int)} .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
