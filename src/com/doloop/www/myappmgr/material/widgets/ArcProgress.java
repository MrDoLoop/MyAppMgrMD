...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = Utilities.sp2px(getResources(), 18);
        min_size = (int) Utilities.dp2px(getResources(), 100);
        default_text_size = Utilities.sp2px(getResources(), 40);
        default_suffix_text_size = Utilities.sp2px(getResources(), 15);
        default_suffix_padding = Utilities.dp2px(getResources(), 4);
        default_suffix_text = "%";
