...
public class PinnedSectionListView extends ListView {
    ...
    void createPinnedShadow(int position) {
       ...
       /* int widthMode = MeasureSpec.getMode(layoutParams.width);
        ...
        int maxWidth = getWidth() - getListPaddingLeft() - getListPaddingRight();
        if (widthSize > maxWidth)
            widthSize = maxWidth;

        int ws = MeasureSpec.makeMeasureSpec(widthSize, widthMode);*/
        // measure & layout
        // int ws = MeasureSpec.makeMeasureSpec(heightSize, heightMode);
        // MeasureSpec.makeMeasureSpec(getWidth() - getListPaddingLeft() - getListPaddingRight(), MeasureSpec.EXACTLY);
        
        //pinnedView.measure(ws, hs);
        pinnedView.measure(hs, hs);
        //pinnedView.layout(0, 0, pinnedView.getMeasuredWidth(), pinnedView.getMeasuredHeight());
        pinnedView.layout(0, 0, pinnedView.getMeasuredHeight(), pinnedView.getMeasuredHeight());
        mTranslateY = 0;
